          ...
          const attemptPlay = async () => {
            try {
                ...
                return new Promise((resolve, reject) => {
                  const onCanPlay = () => {
                    ...
                    video
                      ...
                      .then(() => {
                        console.log(
                          "New video playing successfully after waiting"
                        );
                        resolve(true);
                      })
                      .catch(reject);
              ...
              if (retryCount < maxRetries) {
                retryCount++;
                console.log(
                  `Video play attempt ${retryCount} failed, retrying...`
                );
  ...
  return (
    <>
      ...
      <div
        ...
        className="font-bruno-ace-sc font-normal select-none pointer-events-none text-left overflow-hidden whitespace-nowrap box-border p-0 m-0"
        style={{
      ...
      >
        ...
        <div
          ref={topLeftTextRef}
          className="absolute font-bruno-ace-sc font-normal leading-tight select-none"
          style={{
            fontFamily: "var(--font-bruno-ace-sc), sans-serif",
